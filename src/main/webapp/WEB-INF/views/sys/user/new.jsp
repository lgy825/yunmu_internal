        ...
        <div class="p20">
            ...
            <div class="">
                ...
                <div class="clearfix">
                    ...
                    <span class="color-lred ml8 mt6">* 选择用户所属院线/影投公司</span>
                </div>
                <div class="mt12">
                ...
                <div class="mt12">
                    ...
                    <input id="loginName" maxlength="15" type="text" class="inpW set-inpwid ml8" placeholder="请输入用户名">
                    <span class="color-lred ml8 none">* 不超过15个字母或数字，不能出现其他特殊字符</span>
                </div>
                <div class="mt12">
                    <div class="align-r">登录密码</div>
                    <input id="upassword" maxlength="10" type="text" class="inpW set-inpwid ml8" placeholder="请输入登录密码">
                ...
                <div class="mt12">
                    ...
                    <input id="uphone" maxlength="20" type="text" class="inpW set-inpwid ml8" placeholder="请输入联系电话">
                    <span class="color-lred ml8 none">请输入用户联系电话，可以为固话也可以为手机号，可为空</span>
                </div>
                <div class="mt12">
                    <div class="align-r">邀请码</div>
                    <input id="uinviteCode" type="text" disabled="disabled" class="inpW set-inpwid ml8">
                ...
                <div class="mt12">
                    ...
                    <div id="p_selCimemaPan" class="pl88 mt10 p_selCimema none">
                        <input id="pricinemanamesearch" type="text" class="inpW inpWid1 mr8" placeholder="请输入影院名称">
...
<!-- scripts -->
<script type="text/javascript" src="${ctx}/js/mod/sys/user/new.js"></script>
</html>